...
This project rebuilds the essential internals of a version control system — **object storage, hashing, commit graphs, trees, and references** — all written in **C** to expose what really happens when code meets storage. It’s a hands-on study in **systems programming**, **file system design**, and **data integrity**, focusing on performance, structure, and reproducibility.
